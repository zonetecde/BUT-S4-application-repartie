...
function updateMap() {
    ...
    if (filtreVelib) {
        ...
        const bikeIcon = L.divIcon({
            html: '<div style="font-size: 24px; text-align: center; background: #bfdbfe; border-radius: 50%;">🚲</div>',
            className: "",
            iconSize: [24, 24],
            iconAnchor: [12, 12],
            popupAnchor: [0, -12],
    ...
    if (filtreRestaurant) {
        const foodIcon = L.divIcon({
            html: '<div style="font-size: 24px; text-align: center; background: #bbf7d0; border-radius: 50%;">🍽️</div>',
            className: "",
            iconSize: [24, 24],
            iconAnchor: [12, 12],
            popupAnchor: [0, -12],
