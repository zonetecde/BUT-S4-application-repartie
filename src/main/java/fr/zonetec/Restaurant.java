    ...
    public String chargerDocumentation() {
        ...
        return """
                <section>
                    ...
                    <img src="static/schema-service-restaurant.png" alt="Schéma du service Restaurant" class="my-3 rounded shadow-md max-w-full" />
                    <img src="schema-service-restaurant-2.png" alt="Schéma du service Restaurant" class="my-3 rounded shadow-md max-w-full" />
                </section>
                """;
    }
    /**
